...
import { Package, Plus, Search, Pencil, Trash2, DollarSign, Tag, RefreshCw } from "lucide-react";
          ...
          <div className="overflow-x-auto">
            <Table>
              ...
              <TableBody>
                {loading ? (
                  <TableRow>
                    <TableCell colSpan={5} className="text-center py-10">Loading catalog...</TableCell>
                  </TableRow>
                  ...
                  filteredProducts.map((product) => (
                    <TableRow key={product.id} className="group hover:bg-muted/30 transition-colors">
                      ...
                      <TableCell className="text-right font-black">{formatCurrency(product.unit_price)}</TableCell>
                      <TableCell className="text-right text-muted-foreground">{product.default_tax_rate}%</TableCell>
                      <TableCell>
