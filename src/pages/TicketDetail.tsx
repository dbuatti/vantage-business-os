      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-4">
              {comments.length === 0 ? (
                <p className="text-sm text-muted-foreground text-center py-8 bg-muted/30 rounded-2xl border border-dashed">No comments yet. Start the conversation below.</p>
              ) : (
                ...
                <CardContent className="p-4 space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      />
                      <Label htmlFor="is_internal" className="text-xs font-medium text-muted-foreground">Internal Note (Hidden from client)</Label>
                    </div>
        ...
        <div className="space-y-6">
          <Card className="border-0 shadow-xl">
            ...
            <CardContent className="p-6 space-y-6">
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  <span className="text-xs font-bold text-muted-foreground uppercase">Service Tier</span>
                  <Badge className="bg-primary/10 text-primary border-primary/20 rounded-lg px-3 py-0.5 uppercase text-[10px]">{ticket.service_tier}</Badge>
                </div>
                <div className="pt-4 border-t space-y-3">
                  ...
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span className="font-bold">{ticket.actual_hours || '—'}</span>
                  </div>
                </div>
              </div>
            </CardContent>
          ...
          <Card className="border-0 shadow-xl bg-gradient-to-br from-violet-600 to-indigo-700 text-white overflow-hidden relative">
            ...
            <CardContent className="p-6 relative space-y-4">
              ...
              <Button variant="secondary" className="w-full rounded-xl font-bold gap-2 shadow-lg">
                <Sparkles className="w-4 h-4" /> Analyze Ticket
              </Button>
            </CardContent>
          </Card>
        </div>
