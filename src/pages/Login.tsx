...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      ...
      <Card className="w-full max-w-md shadow-2xl border-0 relative animate-scale-in">
        ...
        <CardContent className="space-y-5">
          ...
          <form onSubmit={handleEmailAuth} className="space-y-4">
            ...
            <Button
              type="submit"
              disabled={isLoading}
              className="w-full h-11 rounded-xl font-semibold bg-gradient-to-r from-primary to-purple-600 hover:from-primary/90 hover:to-purple-600/90 shadow-lg shadow-primary/25"
            >
              {isLoading ? (
